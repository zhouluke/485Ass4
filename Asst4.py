...
import nltk
nltk.data.path[0:0] = ['nltk'] #['/u/csc2501h/include/a4/nltk']
...
nyt_zipped = ZipFilePathPointer('nltk/corpora/nyt.zip')
#('/u/csc2501h/include/a4/nltk/corpora/nyt.zip')
...
# DECOY CORPUS
decoy_zipped = ZipFilePathPointer('decoy.zip')
decoyCorpus = TaggedCorpusReader(decoy_zipped,'SexyDecoys.txt',sep='/')
